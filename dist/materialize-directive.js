...
exports.MaterializeDirective = undefined;

var _core = require('@angular/core');

var _customEventPolyfill = require('./custom-event-polyfill');
...
var MaterializeDirective = function () {
    ...
    function MaterializeDirective(_el) {
        ...
        this.init = new _core.EventEmitter();
    ...
    MaterializeDirective.prototype.performElementUpdates = function () {
        ...
        if (this.isAutocomplete()) {
            ...
            jQueryElement.on("change", function (e) {
                return nativeElement_2.dispatchEvent((0, _customEventPolyfill.CustomEvent)("input"));
            });
        }
        if (this.isDatePicker()) {
            ...
            setTimeout(function () {
                ...
                jqueryPickerElement_1.on('change', function (e) {
                    return nativeElement_3.dispatchEvent((0, _customEventPolyfill.CustomEvent)("input"));
                });
            });
        }
        if (this.isTimePicker()) {
            ...
            setTimeout(function () {
                ...
                jqueryPickerElement_2.on('change', function (e) {
                    return nativeElement_4.dispatchEvent((0, _customEventPolyfill.CustomEvent)("input"));
                });
            });
        }
        if (this.isChips()) {
            ...
            jQueryElement.on("chip.add", function (e, chip) {
                return nativeElement_5.dispatchEvent((0, _customEventPolyfill.CustomEvent)("chip.add", chip));
            });
            jQueryElement.on("chip.delete", function (e, chip) {
                return nativeElement_5.dispatchEvent((0, _customEventPolyfill.CustomEvent)("chip.delete", chip));
            });
            jQueryElement.on("chip.select", function (e, chip) {
                return nativeElement_5.dispatchEvent((0, _customEventPolyfill.CustomEvent)("chip.select", chip));
            });
        }
        if (this.isTextarea()) {
            this._el.nativeElement.dispatchEvent((0, _customEventPolyfill.CustomEvent)("autoresize", {
                bubbles: true,
                cancelable: false,
                detail: undefined
            }));
...
MaterializeDirective.decorators = [{ type: _core.Directive, args: [{
...
MaterializeDirective.ctorParameters = function () {
    return [{ type: _core.ElementRef }];
};
MaterializeDirective.propDecorators = {
    'init': [{ type: _core.Output }],
    'materializeParams': [{ type: _core.Input }],
    'materializeActions': [{ type: _core.Input }],
    'materialize': [{ type: _core.Input }],
    'materializeSelectOptions': [{ type: _core.Input }],
    'ngModel': [{ type: _core.Input }]
};
